...
def read_control():
    with open(r'G:\AES256\Control.txt',encoding='UTF-8-sig',mode='r') as config:
...
key = get_key()
'''
test_text = input("enter anything to encrypt:")
text_encrypt = aes_encrypt(test_text, key)
print(text_encrypt)
text_decrypt = aes_decrypt(text_encrypt,key)
print(text_decrypt)
'''